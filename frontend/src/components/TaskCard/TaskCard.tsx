    ...
    <div className={`${styles.card} ${styles[task.priority]}`}>
      ...
      {!isClosed && (
        <div className={styles.actions}>
          {task.status !== "done" && (
            <button onClick={handleNextStatus} disabled={loading} className={styles.primaryButton}>
              {statusButtonText}
            </button>
          )}

          <button onClick={onEdit} disabled={loading} className={styles.editButton}>
            Editar
          </button>

          <button onClick={onDelete} disabled={loading} className={styles.deleteButton}>
            Deletar
          </button>
        </div>
      )}
